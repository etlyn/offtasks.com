...
export const PublicFooter = () => (
  <footer id="contact" className="mt-20 pb-8 sm:mt-24">
    <div
      className={`grid gap-4 rounded-[34px] border border-white/70 bg-white/64 p-5 shadow-[0_28px_70px_-48px_rgba(15,23,42,0.3)] backdrop-blur-2xl md:p-6 ${
        SHOW_IOS_APP_STORE_DOWNLOAD ? "lg:grid-cols-[minmax(0,1fr)_220px]" : ""
      }`}
    >
