  ...
  return (
    ...
    >
      <button
        ...
        className="overflow-clip relative shrink-0 size-[24px] hover:scale-110 active:scale-95 transition-transform duration-200"
      >
      ...
      <div onClick={() => onClick(id)} className="flex-1 cursor-pointer">
        <p
        ...
        {showMetadata && (priority || label || scheduleLabel) && (
          <div className="flex flex-wrap items-center gap-[6px] mt-[8px]">
            {priority && renderPriorityFlag()}
            {scheduleLabel && (
              <span className="inline-flex items-center px-[8px] py-[3px] rounded-[6px] border font-['Poppins',_sans-serif] text-[11px] bg-zinc-500/10 border-zinc-500/20 text-zinc-600 dark:text-zinc-300">
                {scheduleLabel}
              </span>
            )}
            {label &&
              (() => {
                ...
                return (
                  <span
                    className={`inline-flex items-center px-[8px] py-[3px] rounded-[6px] border font-['Poppins',_sans-serif] text-[11px] ${config.bgColor} ${config.borderColor} ${config.color}`}
                  >
                    {label}
                  </span>
                );
